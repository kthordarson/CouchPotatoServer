...
name_scores = [
    # Tags
    'proper:15', 'repack:15', 'directors cut:15', 'extended:7', 'unrated:2', 'Texti:10', 'ljos:10','texta:10','0xEDsl:15','isl:15', 'Isl:15', '0xCDsl:15', '0xEDslenskum:15', '0xCDslenskum:15', 'islenskum:15', 'Islenskum:15',
    # Video
    'x264:1', 'h264:1',
    # Audio
    'dts:4', 'ac3:2',
    ...
    # Release groups
    'imbt:1', 'cocain:1', 'vomit:1', 'fico:1', 'arrow:1', 'pukka:1', 'prism:1', 'devise:1', 'esir:1', 'ctrlhd:1','eskill:10',
...
def namePositionScore(nzb_name, movie_name):
    ...
    if len(name_split) > 1 and name_year:
        ...
        inbetween = re.split('[\W\-]+', after_name.split(found_quality)[0].strip(), flags=re.U)
