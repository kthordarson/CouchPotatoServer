...
class QualityPlugin(Plugin):
    ...
    qualities = [
        ...
        {'identifier': 'deildu', 'hd': True, 'size': (700, 6000), 'label': 'deildu', 'alternative': ['texti', 'texta', 'Texta', 'isl', 'ísl', 'Ísl', 'íslenskum', 'Íslenskum', 'Texti', 'eskil'], 'allow': ['720p', '1080p','dvdr', 'dvd', 'brrip'], 'ext':['mkv', 'avi'], 'tags': ['texti', 'texta', 'Texta', 'isl', 'ísl', 'Ísl', 'íslenskum', 'Íslenskum', 'Texti', 'eskil', 'unrated', 'UNRATED', 'hdrip', 'brrip']},
